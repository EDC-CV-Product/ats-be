...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('role_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATS_api.role')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATS_api.user')),
            ],
        ),
        migrations.CreateModel(
            name='Skill_Set',
            fields=[
                ...
                ('applicant_cv_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATS_api.applicant_cv')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(max_length=30)),
                ('job_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATS_api.job')),
            ],
        ),
        migrations.AddField(
            model_name='job',
        ...
        migrations.AddField(
            model_name='job',
            name='orgnization_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATS_api.company'),
        ),
        migrations.CreateModel(
            name='Experience',
            fields=[
                ...
                ('applicant_cv_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATS_api.skill_set')),
            ],
        ),
        migrations.CreateModel(
            name='Education',
            fields=[
                ...
                ('applicant_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATS_api.applicant_cv')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application_cv_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATS_api.applicant_cv')),
                ('recuiter_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ATS_api.user')),
            ],
        ),
        migrations.CreateModel(
            name='Candidate',
