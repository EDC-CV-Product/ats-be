...
from ATS_api.views import UserViewSet,User_RoleViewSet,RoleViewSet,Skill_SetViewSet,job_platformsViewSet,CompanyViewSet,applicant_cvViewSet,ExperianceViewSet,EducationViewSet,JobViewSet,job_categoryViewSet,CandidateViewSet,Applicant_DocuemntViewSet,candidate_EvaluationViewSet,Job_Discription_DocumentViewSet
